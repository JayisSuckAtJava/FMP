...
<body><!--
    ...
    <div class="genreCheck">
        ...
        <input type="submit" id="submit" value="적용">
    </form>
    </div>
    <hr>
    <div class="content">
        ...
        <div class="article">
            ...
            <label><input type="checkbox" onclick="firstButton(id)"  id="n-597478-f"> <!-- DB 에 웹툰별 AN(PK) 제작사-번호 -->
                <text>왕뚝배기 동원이 머리 언제 작아졌음?                           <!-- 게시판도 /comment/AN -->
                </text></label>
        ...
        <div class="article">
            ...
            <label><input type="checkbox" onclick="secondButton(id)"  id="M-AN-s">
                <text>댓글 표시 - 더보기를 누를시 각 각 작품별로 따로 댓글 게시판으로 이동함.
                    <button onClick="location.href='/comment?an=an'">댓글 더보기</button>
                </text></label></div>
...
//	 			data{}에서는 EL을 ""로 감싸야함..그외에는 그냥 사용
	...
	function showHtml(data){	
		...
		$.each(data, function(index,item){
			...
			html +="<text>사이트 주인이 만든 글귀<button onClick='location.href=""'>댓글 더보기</button></text></label></div>";					
		});	

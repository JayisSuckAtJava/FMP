    ...
    <div class="main">
        <ul> <!--  -->
            ...
            <li><div class="container">
                <img src="../images/n-783054.jpg" class="tumb">
                <ul>
                ...
                <div class="our rating"><button>점수</button></div>
                <div class="they rating"><button>점수</button></div>
            </div></li>
            <div class="isaid">미션을 깨면 카드를 준다? 심지어 훔쳐보기 까지!?</div>
            <li><div class="container">
                <img src="../images/n-783052.jpg" class="tumb">
                <ul>
